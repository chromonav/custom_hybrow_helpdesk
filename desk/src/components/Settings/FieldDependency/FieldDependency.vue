...
const createUpdateFieldDependency = createResource({
  url: "custom_hybrow_helpdesk.api.settings.field_dependency.create_update_field_dependency",
  auto: false,
  makeParams: () => ({
...
const fieldDependency = createResource({
  url: "custom_hybrow_helpdesk.api.settings.field_dependency.get_field_dependency",
  params: {
