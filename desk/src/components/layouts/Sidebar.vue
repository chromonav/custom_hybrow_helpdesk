  ...
  >
    ...
    <div class="flex flex-col gap-2">
      ...
      <GettingStartedBanner
        ...
        :isSidebarCollapsed="!isExpanded"
        appName="custom_hybrow_helpdesk"
      />
      <SidebarLink
  ...
  },
  {
    ...
    onClick: () => {
      ...
      currentStep.value = {
        title: "Create & invite a contact",
        buttonLabel: "Create",
        videoURL: "/assets/custom_hybrow_helpdesk/desk/videos/createInviteContact.mp4",
        onClick: async () => {
...
const { isOnboardingStepsCompleted, setUp, updateOnboardingStep } =
  useOnboarding("custom_hybrow_helpdesk");
...
async function getFirstTicket() {
  ...
  return await call("custom_hybrow_helpdesk.api.onboarding.get_first_ticket");
}
...
async function getGeneralCategory() {
  ...
  if (!generalCategory) {
    generalCategory = await call(
      "custom_hybrow_helpdesk.api.onboarding.get_general_category_id"
    );
