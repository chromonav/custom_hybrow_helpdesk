...
const { updateOnboardingStep } = useOnboarding("custom_hybrow_helpdesk");
...
const template = createResource({
  url: "custom_hybrow_helpdesk.helpdesk.doctype.hd_ticket_template.api.get_one",
  makeParams: () => ({
...
const ticket = createResource({
  url: "custom_hybrow_helpdesk.helpdesk.doctype.hd_ticket.api.new",
  debounce: 300,
  makeParams: () => ({
    doc: {
