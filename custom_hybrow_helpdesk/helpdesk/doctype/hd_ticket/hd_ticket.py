...
from custom_hybrow_helpdesk.consts import DEFAULT_TICKET_PRIORITY, DEFAULT_TICKET_TYPE
from custom_hybrow_helpdesk.helpdesk.doctype.hd_settings.helpers import (
    get_default_email_content,
    is_email_content_empty,
)
from custom_hybrow_helpdesk.helpdesk.doctype.hd_ticket_activity.hd_ticket_activity import (
    log_ticket_activity,
)
from custom_hybrow_helpdesk.helpdesk.utils.email import (
    default_outgoing_email_account,
    default_ticket_outgoing_email_account,
)
from custom_hybrow_helpdesk.search import HelpdeskSearch
from custom_hybrow_helpdesk.utils import (
    capture_event,
    get_agents_team,
    get_customer,
    is_admin,
